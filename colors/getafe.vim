...
hi ColorColumn                     guibg=#091119   gui=none                            ctermbg=234
...
hi ColorColumn                     guibg=#121314                                       ctermbg=15
hi Cursor          guifg=#1B1D1E   guibg=#FF500E                       ctermfg=234     ctermbg=202
hi CursorLine                      guibg=#121314                       ctermbg=15
hi Directory       guifg=#01B0F0                                       ctermfg=39
hi VertSplit       guifg=#5A7085   guibg=#000000    gui=bold           ctermfg=15      ctermbg=60
hi Folded          guifg=#5A7085   guibg=#FFDC00                       ctermfg=60      ctermbg=220
hi FoldColumn      guifg=#5A7085   guibg=#000000    gui=bold
hi SignColumn      guifg=#FF500E   guibg=#000000    gui=bold           ctermfg=15      ctermbg=234
...
"————————————————————————————————————————————————————————————————————————————————————————————————————————————————————"
" Special for Javascript --  TODO:  - Add colors to the cterm
"————————————————————————————————————————————————————————————————————————————————————————————————————————————————————"

hi javaScriptBrowserObjects       guifg=#ff1e98     gui=italic         ctermfg=182

hi javaScriptDOMObjects           guifg=#FC5ED5     gui=bold
hi javaScriptDOMMethods           guifg=#A3E048                        ctermfg=192
...
hi javaScriptAjaxProperties       guifg=#FC5ED5                        ctermfg=210

hi javaScriptFuncName             guifg=#B5E4F7                        ctermfg=153
hi javaScriptHtmlElemProperties   guifg=#FC5ED5                        ctermfg=210
...
hi ShowMarksHLl guifg=#FF500E guibg=#000000 gui=bold
hi ShowMarksHLo guifg=#FF500E guibg=#000000 gui=bold
hi ShowMarksHLu guifg=#FF500E guibg=#000000 gui=bold
hi ShowMarksHLm guifg=#FF500E guibg=#000000 gui=underline
hi ShowMarksHLm guifg=#FF500E guibg=#000000 gui=underline
hi ShowMarksHLm guifg=#FF500E guibg=#000000 gui=underline
